...
Partial Public Class universityDataSet
    ...
    Private tableКорпуса_Помещения As Корпуса_ПомещенияDataTable
    ...
    Protected Sub New(ByVal info As Global.System.Runtime.Serialization.SerializationInfo, ByVal context As Global.System.Runtime.Serialization.StreamingContext)
        ...
        If (Me.DetermineSchemaSerializationMode(info, context) = Global.System.Data.SchemaSerializationMode.IncludeSchema) Then
            ...
            End If
            If (Not (ds.Tables("Корпуса Помещения")) Is Nothing) Then
                MyBase.Tables.Add(New Корпуса_ПомещенияDataTable(ds.Tables("Корпуса Помещения")))
            End If
    ...
    <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
     ...
     Global.System.ComponentModel.Browsable(false),  _
     Global.System.ComponentModel.DesignerSerializationVisibility(Global.System.ComponentModel.DesignerSerializationVisibility.Content)>  _
    Public ReadOnly Property Корпуса_Помещения() As Корпуса_ПомещенияDataTable
        Get
            Return Me.tableКорпуса_Помещения
        End Get
    End Property
    ...
    Friend Overloads Sub InitVars(ByVal initTable As Boolean)
        ...
        If (initTable = true) Then
            ...
            End If
        End If
        Me.tableКорпуса_Помещения = CType(MyBase.Tables("Корпуса Помещения"),Корпуса_ПомещенияDataTable)
        If (initTable = true) Then
            If (Not (Me.tableКорпуса_Помещения) Is Nothing) Then
                Me.tableКорпуса_Помещения.InitVars
            End If
        End If
    End Sub
    ...
    Private Sub InitClass()
        ...
        Me.tableКорпуса_Помещения = New Корпуса_ПомещенияDataTable()
        MyBase.Tables.Add(Me.tableКорпуса_Помещения)
    End Sub
    ...
    <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
     Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
    Private Function ShouldSerializeКорпуса_Помещения() As Boolean
        Return false
    End Function
    ...
    <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
    Public Delegate Sub Корпуса_ПомещенияRowChangeEventHandler(ByVal sender As Object, ByVal e As Корпуса_ПомещенияRowChangeEvent)
    ...
    Partial Public Class КорпусаDataTable
        ...
        Public Overloads Function AddКорпусаRow( _
                    ...
                    ByVal даты_очередного_текущего_капитального_ремонта As Date,  _
                    ByVal _наличие_мощных_эл___установок As String) As КорпусаRow
            Dim rowКорпусаRow As КорпусаRow = CType(Me.NewRow,КорпусаRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, адрес, год_постройки, общая_площадь, учебная_площадь, _учебно_вспомогательная_площадь, общий_объем, конструктивные_особенности, потребление_электроэнергии_в_летнее_время, потребление_электроэнергии_в_зимнее_время, пиковое_потребление, потребления_тепла, характеристика_пожаро_опасности, характеристика_электро_опасности, дата_последнего_капитального_ремонта, даты_очередного_текущего_капитального_ремонта, _наличие_мощных_эл___установок}
        ...
        Private Sub InitClass()
            ...
            Me._columnналичие_мощных_эл___установок.Caption = "наличие мощных эл. "&Global.Microsoft.VisualBasic.ChrW(10)&"установок"
    ...
    Partial Public Class ПомещенияDataTable
        ...
        Public Overloads Function AddПомещенияRow(ByVal номер_корпуса As Long, ByVal номер_помещения As Long, ByVal этаж As Long, ByVal площадь As Long, ByVal объем As Long, ByVal вид_помещения As String, ByVal конструктивные_особенности As String, ByVal _категория_электро___безопасности As String, ByVal _категория_пожаро_безопасности As String, ByVal потребляемая_мощность_электроэнергии As Long, ByVal дата_последнего_капитального_ремонта As Date, ByVal даты_очередного_текущего_капитального_ремонта As Date) As ПомещенияRow
            ...
            Dim columnValuesArray() As Object = New Object() {номер_корпуса, номер_помещения, этаж, площадь, объем, вид_помещения, конструктивные_особенности, _категория_электро___безопасности, _категория_пожаро_безопасности, потребляемая_мощность_электроэнергии, дата_последнего_капитального_ремонта, даты_очередного_текущего_капитального_ремонта, Nothing}
        ...
        Private Sub InitClass()
            ...
            Me.columnконструктивные_особенности.MaxLength = 50
            Me._columnкатегория_электро___безопасности.MaxLength = 10
            Me._columnкатегория_пожаро_безопасности.MaxLength = 10
    ...
    <Global.System.Serializable(),  _
     Global.System.Xml.Serialization.XmlSchemaProviderAttribute("GetTypedTableSchema")>  _
    Partial Public Class Корпуса_ПомещенияDataTable
        Inherits Global.System.Data.TypedTableBase(Of Корпуса_ПомещенияRow)
        ...
        Public Sub New()
            MyBase.New
            Me.TableName = "Корпуса Помещения"
            Me.BeginInit
            Me.InitClass
            Me.EndInit
        End Sub
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Default ReadOnly Property Item(ByVal index As Integer) As Корпуса_ПомещенияRow
            Get
                Return CType(Me.Rows(index),Корпуса_ПомещенияRow)
            End Get
        End Property
        
        <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Event Корпуса_ПомещенияRowChanging As Корпуса_ПомещенияRowChangeEventHandler
        
        <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Event Корпуса_ПомещенияRowChanged As Корпуса_ПомещенияRowChangeEventHandler
        
        <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Event Корпуса_ПомещенияRowDeleting As Корпуса_ПомещенияRowChangeEventHandler
        
        <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Event Корпуса_ПомещенияRowDeleted As Корпуса_ПомещенияRowChangeEventHandler
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Overloads Sub AddКорпуса_ПомещенияRow(ByVal row As Корпуса_ПомещенияRow)
            Me.Rows.Add(row)
        End Sub
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Overloads Function AddКорпуса_ПомещенияRow(ByVal номер_помещения As Long, ByVal этаж As Long, ByVal площадь As Long, ByVal объем As Long, ByVal Expr2 As String, ByVal вид_помещения As String, ByVal _категория_электро___безопасности As String, ByVal _категория_пожаро_безопасности As String, ByVal потребляемая_мощность_электроэнергии As Long, ByVal Expr3 As Date, ByVal Expr4 As Date, ByVal номер_корпуса As Long, ByVal адрес As String) As Корпуса_ПомещенияRow
            Dim rowКорпуса_ПомещенияRow As Корпуса_ПомещенияRow = CType(Me.NewRow,Корпуса_ПомещенияRow)
            Dim columnValuesArray() As Object = New Object() {номер_помещения, этаж, площадь, объем, Expr2, вид_помещения, _категория_электро___безопасности, _категория_пожаро_безопасности, потребляемая_мощность_электроэнергии, Expr3, Expr4, номер_корпуса, адрес}
            rowКорпуса_ПомещенияRow.ItemArray = columnValuesArray
            Me.Rows.Add(rowКорпуса_ПомещенияRow)
            Return rowКорпуса_ПомещенияRow
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Function FindByномер_корпуса(ByVal номер_корпуса As Long) As Корпуса_ПомещенияRow
            Return CType(Me.Rows.Find(New Object() {номер_корпуса}),Корпуса_ПомещенияRow)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Overrides Function Clone() As Global.System.Data.DataTable
            Dim cln As Корпуса_ПомещенияDataTable = CType(MyBase.Clone,Корпуса_ПомещенияDataTable)
            cln.InitVars
            Return cln
        End Function
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Protected Overrides Function CreateInstance() As Global.System.Data.DataTable
            Return New Корпуса_ПомещенияDataTable()
        End Function
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Function NewКорпуса_ПомещенияRow() As Корпуса_ПомещенияRow
            Return CType(Me.NewRow,Корпуса_ПомещенияRow)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Protected Overrides Function NewRowFromBuilder(ByVal builder As Global.System.Data.DataRowBuilder) As Global.System.Data.DataRow
            Return New Корпуса_ПомещенияRow(builder)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Protected Overrides Function GetRowType() As Global.System.Type
            Return GetType(Корпуса_ПомещенияRow)
        End Function
        ...
        Protected Overrides Sub OnRowChanged(ByVal e As Global.System.Data.DataRowChangeEventArgs)
            MyBase.OnRowChanged(e)
            If (Not (Me.Корпуса_ПомещенияRowChangedEvent) Is Nothing) Then
                RaiseEvent Корпуса_ПомещенияRowChanged(Me, New Корпуса_ПомещенияRowChangeEvent(CType(e.Row,Корпуса_ПомещенияRow), e.Action))
            End If
        End Sub
        ...
        Protected Overrides Sub OnRowChanging(ByVal e As Global.System.Data.DataRowChangeEventArgs)
            MyBase.OnRowChanging(e)
            If (Not (Me.Корпуса_ПомещенияRowChangingEvent) Is Nothing) Then
                RaiseEvent Корпуса_ПомещенияRowChanging(Me, New Корпуса_ПомещенияRowChangeEvent(CType(e.Row,Корпуса_ПомещенияRow), e.Action))
            End If
        End Sub
        ...
        Protected Overrides Sub OnRowDeleted(ByVal e As Global.System.Data.DataRowChangeEventArgs)
            MyBase.OnRowDeleted(e)
            If (Not (Me.Корпуса_ПомещенияRowDeletedEvent) Is Nothing) Then
                RaiseEvent Корпуса_ПомещенияRowDeleted(Me, New Корпуса_ПомещенияRowChangeEvent(CType(e.Row,Корпуса_ПомещенияRow), e.Action))
            End If
        End Sub
        ...
        Protected Overrides Sub OnRowDeleting(ByVal e As Global.System.Data.DataRowChangeEventArgs)
            MyBase.OnRowDeleting(e)
            If (Not (Me.Корпуса_ПомещенияRowDeletingEvent) Is Nothing) Then
                RaiseEvent Корпуса_ПомещенияRowDeleting(Me, New Корпуса_ПомещенияRowChangeEvent(CType(e.Row,Корпуса_ПомещенияRow), e.Action))
            End If
        End Sub
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Sub RemoveКорпуса_ПомещенияRow(ByVal row As Корпуса_ПомещенияRow)
            Me.Rows.Remove(row)
        End Sub
        ...
        Public Shared Function GetTypedTableSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
            ...
            Dim attribute2 As Global.System.Xml.Schema.XmlSchemaAttribute = New Global.System.Xml.Schema.XmlSchemaAttribute()
            attribute2.Name = "tableTypeName"
            attribute2.FixedValue = "Корпуса_ПомещенияDataTable"
            type.Attributes.Add(attribute2)
            type.Particle = sequence
            Dim dsSchema As Global.System.Xml.Schema.XmlSchema = ds.GetSchemaSerializable
            If xs.Contains(dsSchema.TargetNamespace) Then
    ...
    '''Represents strongly named DataRow class.
    '''</summary>
    Partial Public Class Корпуса_ПомещенияRow
        Inherits Global.System.Data.DataRow
        ...
        Friend Sub New(ByVal rb As Global.System.Data.DataRowBuilder)
            MyBase.New(rb)
            Me.tableКорпуса_Помещения = CType(Me.Table,Корпуса_ПомещенияDataTable)
        End Sub
        ...
        Public Property номер_помещения() As Long
            Get
                Try 
                    Return CType(Me(Me.tableКорпуса_Помещения.номер_помещенияColumn),Long)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("Значение для столбца 'номер помещения' в таблице 'Корпуса Помещения' равно DBNull"& _ 
                            ".", e)
                End Try
            End Get
            Set
                Me(Me.tableКорпуса_Помещения.номер_помещенияColumn) = value
            End Set
        End Property
        ...
        Public Property этаж() As Long
            Get
                Try 
                    Return CType(Me(Me.tableКорпуса_Помещения.этажColumn),Long)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("Значение для столбца 'этаж' в таблице 'Корпуса Помещения' равно DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableКорпуса_Помещения.этажColumn) = value
            End Set
        End Property
        ...
        Public Property площадь() As Long
            Get
                Try 
                    Return CType(Me(Me.tableКорпуса_Помещения.площадьColumn),Long)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("Значение для столбца 'площадь' в таблице 'Корпуса Помещения' равно DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableКорпуса_Помещения.площадьColumn) = value
            End Set
        End Property
        ...
        Public Property объем() As Long
            Get
                Try 
                    Return CType(Me(Me.tableКорпуса_Помещения.объемColumn),Long)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("Значение для столбца 'объем' в таблице 'Корпуса Помещения' равно DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableКорпуса_Помещения.объемColumn) = value
            End Set
        End Property
        ...
        Public Property Expr2() As String
            Get
                Try 
                    Return CType(Me(Me.tableКорпуса_Помещения.Expr2Column),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("Значение для столбца 'Expr2' в таблице 'Корпуса Помещения' равно DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableКорпуса_Помещения.Expr2Column) = value
            End Set
        End Property
        ...
        Public Property вид_помещения() As String
            Get
                Try 
                    Return CType(Me(Me.tableКорпуса_Помещения.вид_помещенияColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("Значение для столбца 'вид помещения' в таблице 'Корпуса Помещения' равно DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableКорпуса_Помещения.вид_помещенияColumn) = value
            End Set
        End Property
        ...
        Public Property _категория_электро___безопасности() As String
            Get
                Try 
                    Return CType(Me(Me.tableКорпуса_Помещения._категория_электро___безопасностиColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("Значение для столбца 'категория электро - безопасности' в таблице 'Корпуса Помеще"& _ 
                            "ния' равно DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableКорпуса_Помещения._категория_электро___безопасностиColumn) = value
            End Set
        End Property
        ...
        Public Property _категория_пожаро_безопасности() As String
            Get
                Try 
                    Return CType(Me(Me.tableКорпуса_Помещения._категория_пожаро_безопасностиColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("Значение для столбца 'категория пожаро-безопасности' в таблице 'Корпуса Помещения"& _ 
                            "' равно DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableКорпуса_Помещения._категория_пожаро_безопасностиColumn) = value
            End Set
        End Property
        ...
        Public Property потребляемая_мощность_электроэнергии() As Long
            Get
                Try 
                    Return CType(Me(Me.tableКорпуса_Помещения.потребляемая_мощность_электроэнергииColumn),Long)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("Значение для столбца 'потребляемая мощность электроэнергии' в таблице 'Корпуса По"& _ 
                            "мещения' равно DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableКорпуса_Помещения.потребляемая_мощность_электроэнергииColumn) = value
            End Set
        End Property
        ...
        Public Property Expr3() As Date
            Get
                Try 
                    Return CType(Me(Me.tableКорпуса_Помещения.Expr3Column),Date)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("Значение для столбца 'Expr3' в таблице 'Корпуса Помещения' равно DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableКорпуса_Помещения.Expr3Column) = value
            End Set
        End Property
        ...
        Public Property Expr4() As Date
            Get
                Try 
                    Return CType(Me(Me.tableКорпуса_Помещения.Expr4Column),Date)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("Значение для столбца 'Expr4' в таблице 'Корпуса Помещения' равно DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableКорпуса_Помещения.Expr4Column) = value
            End Set
        End Property
        ...
        Public Property номер_корпуса() As Long
            Get
                Return CType(Me(Me.tableКорпуса_Помещения.номер_корпусаColumn),Long)
            End Get
            Set
                Me(Me.tableКорпуса_Помещения.номер_корпусаColumn) = value
            End Set
        End Property
        ...
        Public Property адрес() As String
            Get
                Try 
                    Return CType(Me(Me.tableКорпуса_Помещения.адресColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("Значение для столбца 'адрес' в таблице 'Корпуса Помещения' равно DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableКорпуса_Помещения.адресColumn) = value
            End Set
        End Property
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Function Isномер_помещенияNull() As Boolean
            Return Me.IsNull(Me.tableКорпуса_Помещения.номер_помещенияColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Sub Setномер_помещенияNull()
            Me(Me.tableКорпуса_Помещения.номер_помещенияColumn) = Global.System.Convert.DBNull
        End Sub
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Function IsэтажNull() As Boolean
            Return Me.IsNull(Me.tableКорпуса_Помещения.этажColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Sub SetэтажNull()
            Me(Me.tableКорпуса_Помещения.этажColumn) = Global.System.Convert.DBNull
        End Sub
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Function IsплощадьNull() As Boolean
            Return Me.IsNull(Me.tableКорпуса_Помещения.площадьColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Sub SetплощадьNull()
            Me(Me.tableКорпуса_Помещения.площадьColumn) = Global.System.Convert.DBNull
        End Sub
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Function IsобъемNull() As Boolean
            Return Me.IsNull(Me.tableКорпуса_Помещения.объемColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Sub SetобъемNull()
            Me(Me.tableКорпуса_Помещения.объемColumn) = Global.System.Convert.DBNull
        End Sub
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Function IsExpr2Null() As Boolean
            Return Me.IsNull(Me.tableКорпуса_Помещения.Expr2Column)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Sub SetExpr2Null()
            Me(Me.tableКорпуса_Помещения.Expr2Column) = Global.System.Convert.DBNull
        End Sub
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Function Isвид_помещенияNull() As Boolean
            Return Me.IsNull(Me.tableКорпуса_Помещения.вид_помещенияColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Sub Setвид_помещенияNull()
            Me(Me.tableКорпуса_Помещения.вид_помещенияColumn) = Global.System.Convert.DBNull
        End Sub
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Function Is_категория_электро___безопасностиNull() As Boolean
            Return Me.IsNull(Me.tableКорпуса_Помещения._категория_электро___безопасностиColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Sub Set_категория_электро___безопасностиNull()
            Me(Me.tableКорпуса_Помещения._категория_электро___безопасностиColumn) = Global.System.Convert.DBNull
        End Sub
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Function Is_категория_пожаро_безопасностиNull() As Boolean
            Return Me.IsNull(Me.tableКорпуса_Помещения._категория_пожаро_безопасностиColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Sub Set_категория_пожаро_безопасностиNull()
            Me(Me.tableКорпуса_Помещения._категория_пожаро_безопасностиColumn) = Global.System.Convert.DBNull
        End Sub
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Function Isпотребляемая_мощность_электроэнергииNull() As Boolean
            Return Me.IsNull(Me.tableКорпуса_Помещения.потребляемая_мощность_электроэнергииColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Sub Setпотребляемая_мощность_электроэнергииNull()
            Me(Me.tableКорпуса_Помещения.потребляемая_мощность_электроэнергииColumn) = Global.System.Convert.DBNull
        End Sub
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Function IsExpr3Null() As Boolean
            Return Me.IsNull(Me.tableКорпуса_Помещения.Expr3Column)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Sub SetExpr3Null()
            Me(Me.tableКорпуса_Помещения.Expr3Column) = Global.System.Convert.DBNull
        End Sub
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Function IsExpr4Null() As Boolean
            Return Me.IsNull(Me.tableКорпуса_Помещения.Expr4Column)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Sub SetExpr4Null()
            Me(Me.tableКорпуса_Помещения.Expr4Column) = Global.System.Convert.DBNull
        End Sub
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Function IsадресNull() As Boolean
            Return Me.IsNull(Me.tableКорпуса_Помещения.адресColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Sub SetадресNull()
            Me(Me.tableКорпуса_Помещения.адресColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
    ...
    '''</summary>
    <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
    Public Class Корпуса_ПомещенияRowChangeEvent
        Inherits Global.System.EventArgs
        
        Private eventRow As Корпуса_ПомещенияRow
        
        Private eventAction As Global.System.Data.DataRowAction
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Sub New(ByVal row As Корпуса_ПомещенияRow, ByVal action As Global.System.Data.DataRowAction)
            MyBase.New
            Me.eventRow = row
            Me.eventAction = action
        End Sub
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public ReadOnly Property Row() As Корпуса_ПомещенияRow
            Get
                Return Me.eventRow
            End Get
        End Property
...
Namespace universityDataSetTableAdapters
    ...
    Partial Public Class Виды_помещенийTableAdapter
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.WindowsApp1.My.MySettings.Default.universityConnectionString
        End Sub
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As universityDataSet.Виды_помещенийDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As universityDataSet.Виды_помещенийDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As universityDataSet.Виды_помещенийDataTable = New universityDataSet.Виды_помещенийDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As universityDataSet.Виды_помещенийDataTable) As Integer
    ...
    Partial Public Class конструктивная_особенностьTableAdapter
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, true)>  _
        Public Overloads Overridable Function Fill(ByVal dataTable As universityDataSet.конструктивная_особенностьDataTable) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            If (Me.ClearBeforeFill = true) Then
                dataTable.Clear
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Overridable Function GetData() As universityDataSet.конструктивная_особенностьDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As universityDataSet.конструктивная_особенностьDataTable = New universityDataSet.конструктивная_особенностьDataTable()
            Me.Adapter.Fill(dataTable)
            Return dataTable
        End Function
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As universityDataSet.конструктивная_особенностьDataTable) As Integer
            Return Me.Adapter.Update(dataTable)
        End Function
    ...
    Partial Public Class КорпусаTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.DeleteCommand.Connection = Me.Connection
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [Корпуса] WHERE (([номер корпуса] = @Original_номер_корпуса) AND ((@I"& _ 
                "sNull_адрес = 1 AND [адрес] IS NULL) OR ([адрес] = @Original_адрес)) AND ((@IsNu"& _ 
                "ll_год_постройки = 1 AND [год постройки] IS NULL) OR ([год постройки] = @Origina"& _ 
                "l_год_постройки)) AND ((@IsNull_общая_площадь = 1 AND [общая площадь] IS NULL) O"& _ 
                "R ([общая площадь] = @Original_общая_площадь)) AND ((@IsNull_учебная_площадь = 1"& _ 
                " AND [учебная площадь] IS NULL) OR ([учебная площадь] = @Original_учебная_площад"& _ 
                "ь)) AND ((@p3 = 1 AND [учебно-вспомогательная площадь] IS NULL) OR ([учебно-вспо"& _ 
                "могательная площадь] = @p2)) AND ((@IsNull_общий_объем = 1 AND [общий объем] IS "& _ 
                "NULL) OR ([общий объем] = @Original_общий_объем)) AND ((@IsNull_конструктивные_о"& _ 
                "собенности = 1 AND [конструктивные особенности] IS NULL) OR ([конструктивные осо"& _ 
                "бенности] = @Original_конструктивные_особенности)) AND ((@IsNull_потребление_эле"& _ 
                "ктроэнергии_в_летнее_время = 1 AND [потребление электроэнергии в летнее время] I"& _ 
                "S NULL) OR ([потребление электроэнергии в летнее время] = @Original_потребление_"& _ 
                "электроэнергии_в_летнее_время)) AND ((@IsNull_потребление_электроэнергии_в_зимне"& _ 
                "е_время = 1 AND [потребление электроэнергии в зимнее время] IS NULL) OR ([потреб"& _ 
                "ление электроэнергии в зимнее время] = @Original_потребление_электроэнергии_в_зи"& _ 
                "мнее_время)) AND ((@IsNull_пиковое_потребление = 1 AND [пиковое потребление] IS "& _ 
                "NULL) OR ([пиковое потребление] = @Original_пиковое_потребление)) AND ((@IsNull_"& _ 
                "потребления_тепла = 1 AND [потребления тепла] IS NULL) OR ([потребления тепла] ="& _ 
                " @Original_потребления_тепла)) AND ((@IsNull_характеристика_пожаро_опасности = 1"& _ 
                " AND [характеристика пожаро опасности] IS NULL) OR ([характеристика пожаро опасн"& _ 
                "ости] = @Original_характеристика_пожаро_опасности)) AND ((@IsNull_характеристика"& _ 
                "_электро_опасности = 1 AND [характеристика электро опасности] IS NULL) OR ([хара"& _ 
                "ктеристика электро опасности] = @Original_характеристика_электро_опасности)) AND"& _ 
                " ((@IsNull_дата_последнего_капитального_ремонта = 1 AND [дата последнего капитал"& _ 
                "ьного ремонта] IS NULL) OR ([дата последнего капитального ремонта] = @Original_д"& _ 
                "ата_последнего_капитального_ремонта)) AND ((@IsNull_даты_очередного_текущего_кап"& _ 
                "итального_ремонта = 1 AND [даты очередного текущего капитального ремонта] IS NUL"& _ 
                "L) OR ([даты очередного текущего капитального ремонта] = @Original_даты_очередно"& _ 
                "го_текущего_капитального_ремонта)) AND ((@p6 = 1 AND [наличие мощных эл. "&Global.Microsoft.VisualBasic.ChrW(10)&"устано"& _ 
                "вок] IS NULL) OR ([наличие мощных эл. "&Global.Microsoft.VisualBasic.ChrW(10)&"установок] = @p5)))"
            Me._adapter.DeleteCommand.CommandType = Global.System.Data.CommandType.Text
            ...
            Me._adapter.InsertCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [Корпуса] ([адрес], [год постройки], [общая площадь], [учебная площад"& _ 
                "ь], [учебно-вспомогательная площадь], [общий объем], [конструктивные особенности"& _ 
                "], [потребление электроэнергии в летнее время], [потребление электроэнергии в зи"& _ 
                "мнее время], [пиковое потребление], [потребления тепла], [характеристика пожаро "& _ 
                "опасности], [характеристика электро опасности], [дата последнего капитального ре"& _ 
                "монта], [даты очередного текущего капитального ремонта], [наличие мощных эл. "&Global.Microsoft.VisualBasic.ChrW(10)&"ус"& _ 
                "тановок]) VALUES (@адрес, @год_постройки, @общая_площадь, @учебная_площадь, @p1,"& _ 
                " @общий_объем, @конструктивные_особенности, @потребление_электроэнергии_в_летнее"& _ 
                "_время, @потребление_электроэнергии_в_зимнее_время, @пиковое_потребление, @потре"& _ 
                "бления_тепла, @характеристика_пожаро_опасности, @характеристика_электро_опасност"& _ 
                "и, @дата_последнего_капитального_ремонта, @даты_очередного_текущего_капитального"& _ 
                "_ремонта, @p4);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT [номер корпуса], адрес, [год постройки], [общая площадь]"& _ 
                ", [учебная площадь], [учебно-вспомогательная площадь], [общий объем], [конструкт"& _ 
                "ивные особенности], [потребление электроэнергии в летнее время], [потребление эл"& _ 
                "ектроэнергии в зимнее время], [пиковое потребление], [потребления тепла], [харак"& _ 
                "теристика пожаро опасности], [характеристика электро опасности], [дата последнег"& _ 
                "о капитального ремонта], [даты очередного текущего капитального ремонта], [налич"& _ 
                "ие мощных эл. "&Global.Microsoft.VisualBasic.ChrW(10)&"установок] FROM Корпуса WHERE ([номер корпуса] = SCOPE_IDENTITY()"& _ 
                ")"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            ...
            Me._adapter.UpdateCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE [Корпуса] SET [адрес] = @адрес, [год постройки] = @год_постройки, [общая п"& _ 
                "лощадь] = @общая_площадь, [учебная площадь] = @учебная_площадь, [учебно-вспомога"& _ 
                "тельная площадь] = @p1, [общий объем] = @общий_объем, [конструктивные особенност"& _ 
                "и] = @конструктивные_особенности, [потребление электроэнергии в летнее время] = "& _ 
                "@потребление_электроэнергии_в_летнее_время, [потребление электроэнергии в зимнее"& _ 
                " время] = @потребление_электроэнергии_в_зимнее_время, [пиковое потребление] = @п"& _ 
                "иковое_потребление, [потребления тепла] = @потребления_тепла, [характеристика по"& _ 
                "жаро опасности] = @характеристика_пожаро_опасности, [характеристика электро опас"& _ 
                "ности] = @характеристика_электро_опасности, [дата последнего капитального ремонт"& _ 
                "а] = @дата_последнего_капитального_ремонта, [даты очередного текущего капитально"& _ 
                "го ремонта] = @даты_очередного_текущего_капитального_ремонта, [наличие мощных эл"& _ 
                ". "&Global.Microsoft.VisualBasic.ChrW(10)&"установок] = @p4 WHERE (([номер корпуса] = @Original_номер_корпуса) AND ((@Is"& _ 
                "Null_адрес = 1 AND [адрес] IS NULL) OR ([адрес] = @Original_адрес)) AND ((@IsNul"& _ 
                "l_год_постройки = 1 AND [год постройки] IS NULL) OR ([год постройки] = @Original"& _ 
                "_год_постройки)) AND ((@IsNull_общая_площадь = 1 AND [общая площадь] IS NULL) OR"& _ 
                " ([общая площадь] = @Original_общая_площадь)) AND ((@IsNull_учебная_площадь = 1 "& _ 
                "AND [учебная площадь] IS NULL) OR ([учебная площадь] = @Original_учебная_площадь"& _ 
                ")) AND ((@p3 = 1 AND [учебно-вспомогательная площадь] IS NULL) OR ([учебно-вспом"& _ 
                "огательная площадь] = @p2)) AND ((@IsNull_общий_объем = 1 AND [общий объем] IS N"& _ 
                "ULL) OR ([общий объем] = @Original_общий_объем)) AND ((@IsNull_конструктивные_ос"& _ 
                "обенности = 1 AND [конструктивные особенности] IS NULL) OR ([конструктивные особ"& _ 
                "енности] = @Original_конструктивные_особенности)) AND ((@IsNull_потребление_элек"& _ 
                "троэнергии_в_летнее_время = 1 AND [потребление электроэнергии в летнее время] IS"& _ 
                " NULL) OR ([потребление электроэнергии в летнее время] = @Original_потребление_э"& _ 
                "лектроэнергии_в_летнее_время)) AND ((@IsNull_потребление_электроэнергии_в_зимнее"& _ 
                "_время = 1 AND [потребление электроэнергии в зимнее время] IS NULL) OR ([потребл"& _ 
                "ение электроэнергии в зимнее время] = @Original_потребление_электроэнергии_в_зим"& _ 
                "нее_время)) AND ((@IsNull_пиковое_потребление = 1 AND [пиковое потребление] IS N"& _ 
                "ULL) OR ([пиковое потребление] = @Original_пиковое_потребление)) AND ((@IsNull_п"& _ 
                "отребления_тепла = 1 AND [потребления тепла] IS NULL) OR ([потребления тепла] = "& _ 
                "@Original_потребления_тепла)) AND ((@IsNull_характеристика_пожаро_опасности = 1 "& _ 
                "AND [характеристика пожаро опасности] IS NULL) OR ([характеристика пожаро опасно"& _ 
                "сти] = @Original_характеристика_пожаро_опасности)) AND ((@IsNull_характеристика_"& _ 
                "электро_опасности = 1 AND [характеристика электро опасности] IS NULL) OR ([харак"& _ 
                "теристика электро опасности] = @Original_характеристика_электро_опасности)) AND "& _ 
                "((@IsNull_дата_последнего_капитального_ремонта = 1 AND [дата последнего капиталь"& _ 
                "ного ремонта] IS NULL) OR ([дата последнего капитального ремонта] = @Original_да"& _ 
                "та_последнего_капитального_ремонта)) AND ((@IsNull_даты_очередного_текущего_капи"& _ 
                "тального_ремонта = 1 AND [даты очередного текущего капитального ремонта] IS NULL"& _ 
                ") OR ([даты очередного текущего капитального ремонта] = @Original_даты_очередног"& _ 
                "о_текущего_капитального_ремонта)) AND ((@p6 = 1 AND [наличие мощных эл. "&Global.Microsoft.VisualBasic.ChrW(10)&"установ"& _ 
                "ок] IS NULL) OR ([наличие мощных эл. "&Global.Microsoft.VisualBasic.ChrW(10)&"установок] = @p5)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT [номер корпус"& _ 
                "а], адрес, [год постройки], [общая площадь], [учебная площадь], [учебно-вспомога"& _ 
                "тельная площадь], [общий объем], [конструктивные особенности], [потребление элек"& _ 
                "троэнергии в летнее время], [потребление электроэнергии в зимнее время], [пиково"& _ 
                "е потребление], [потребления тепла], [характеристика пожаро опасности], [характе"& _ 
                "ристика электро опасности], [дата последнего капитального ремонта], [даты очеред"& _ 
                "ного текущего капитального ремонта], [наличие мощных эл. "&Global.Microsoft.VisualBasic.ChrW(10)&"установок] FROM Корпус"& _ 
                "а WHERE ([номер корпуса] = @номер_корпуса)"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT [номер корпуса], адрес, [год постройки], [общая площадь], [учебная площадь"& _ 
                ...
                "нее время], [пиковое потребление], [потребления тепла], [характеристика пожаро о"& _ 
                "пасности], [характеристика электро опасности], [дата последнего капитального рем"& _ 
                "онта], [даты очередного текущего капитального ремонта], [наличие мощных эл. "&Global.Microsoft.VisualBasic.ChrW(10)&"уст"& _ 
                "ановок] FROM Корпуса"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT [номер корпуса], адрес, [год постройки], [общая площадь], [учебная площадь"& _ 
                "], [учебно-вспомогательная площадь], [общий объем], [конструктивные особенности]"& _ 
                ", [потребление электроэнергии в летнее время], [потребление электроэнергии в зим"& _ 
                "нее время], [пиковое потребление], [потребления тепла], [характеристика пожаро о"& _ 
                "пасности], [характеристика электро опасности], [дата последнего капитального рем"& _ 
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, true)>  _
        Public Overloads Overridable Function Fill(ByVal dataTable As universityDataSet.КорпусаDataTable) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            If (Me.ClearBeforeFill = true) Then
                dataTable.Clear
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Overridable Function GetData() As universityDataSet.КорпусаDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As universityDataSet.КорпусаDataTable = New universityDataSet.КорпусаDataTable()
            Me.Adapter.Fill(dataTable)
            Return dataTable
        End Function
        ...
        Public Overloads Overridable Function FillBy(ByVal dataTable As universityDataSet.КорпусаDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As universityDataSet.КорпусаDataTable) As Integer
            Return Me.Adapter.Update(dataTable)
        End Function
        ...
        Public Overloads Overridable Function Delete( _
            ...
            If (Original_потребления_тепла.HasValue = true) Then
                ...
                Me.Adapter.DeleteCommand.Parameters(22).Value = CType(Original_потребления_тепла.Value,Long)
            Else
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(24).Value = CType(Original_характеристика_пожаро_опасности,String)
            End If
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(26).Value = CType(Original_характеристика_электро_опасности,String)
            End If
            If (Original_дата_последнего_капитального_ремонта.HasValue = true) Then
                Me.Adapter.DeleteCommand.Parameters(27).Value = CType(0,Object)
                Me.Adapter.DeleteCommand.Parameters(28).Value = CType(Original_дата_последнего_капитального_ремонта.Value,Date)
            Else
            ...
            If (Original_даты_очередного_текущего_капитального_ремонта.HasValue = true) Then
                ...
                Me.Adapter.DeleteCommand.Parameters(30).Value = CType(Original_даты_очередного_текущего_капитального_ремонта.Value,Date)
            Else
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(32).Value = CType(p5,String)
            End If
            Dim previousConnectionState As Global.System.Data.ConnectionState = Me.Adapter.DeleteCommand.Connection.State
            If ((Me.Adapter.DeleteCommand.Connection.State And Global.System.Data.ConnectionState.Open)  _
                        <> Global.System.Data.ConnectionState.Open) Then
        ...
        Public Overloads Overridable Function Insert( _
            ...
            If (потребления_тепла.HasValue = true) Then
                Me.Adapter.InsertCommand.Parameters(10).Value = CType(потребления_тепла.Value,Long)
            Else
            ...
            Else
                Me.Adapter.InsertCommand.Parameters(11).Value = CType(характеристика_пожаро_опасности,String)
            End If
            If (характеристика_электро_опасности Is Nothing) Then
                Me.Adapter.InsertCommand.Parameters(12).Value = Global.System.DBNull.Value
            Else
                Me.Adapter.InsertCommand.Parameters(12).Value = CType(характеристика_электро_опасности,String)
            End If
            If (дата_последнего_капитального_ремонта.HasValue = true) Then
                Me.Adapter.InsertCommand.Parameters(13).Value = CType(дата_последнего_капитального_ремонта.Value,Date)
            Else
                Me.Adapter.InsertCommand.Parameters(13).Value = Global.System.DBNull.Value
            End If
            If (даты_очередного_текущего_капитального_ремонта.HasValue = true) Then
                Me.Adapter.InsertCommand.Parameters(14).Value = CType(даты_очередного_текущего_капитального_ремонта.Value,Date)
            Else
            ...
            Else
                Me.Adapter.InsertCommand.Parameters(15).Value = CType(p4,String)
            End If
            Dim previousConnectionState As Global.System.Data.ConnectionState = Me.Adapter.InsertCommand.Connection.State
            If ((Me.Adapter.InsertCommand.Connection.State And Global.System.Data.ConnectionState.Open)  _
                        <> Global.System.Data.ConnectionState.Open) Then
        ...
        Public Overloads Overridable Function Update( _
            ...
            End If
            If (потребления_тепла.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(10).Value = CType(потребления_тепла.Value,Long)
            Else
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(11).Value = CType(характеристика_пожаро_опасности,String)
            End If
            If (характеристика_электро_опасности Is Nothing) Then
                Me.Adapter.UpdateCommand.Parameters(12).Value = Global.System.DBNull.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(12).Value = CType(характеристика_электро_опасности,String)
            End If
            If (дата_последнего_капитального_ремонта.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(13).Value = CType(дата_последнего_капитального_ремонта.Value,Date)
            Else
                Me.Adapter.UpdateCommand.Parameters(13).Value = Global.System.DBNull.Value
            End If
            If (даты_очередного_текущего_капитального_ремонта.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(14).Value = CType(даты_очередного_текущего_капитального_ремонта.Value,Date)
            Else
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(15).Value = CType(p4,String)
            End If
            ...
            If (Original_потребления_тепла.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(38).Value = CType(Original_потребления_тепла.Value,Long)
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(40).Value = CType(Original_характеристика_пожаро_опасности,String)
            End If
            If (Original_характеристика_электро_опасности Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(42).Value = CType(Original_характеристика_электро_опасности,String)
            End If
            If (Original_дата_последнего_капитального_ремонта.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(43).Value = CType(0,Object)
                Me.Adapter.UpdateCommand.Parameters(44).Value = CType(Original_дата_последнего_капитального_ремонта.Value,Date)
            Else
            ...
            If (Original_даты_очередного_текущего_капитального_ремонта.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(46).Value = CType(Original_даты_очередного_текущего_капитального_ремонта.Value,Date)
            Else
        ...
        Public Overloads Overridable Function Update( _
                    ...
                    ByVal Original_даты_очередного_текущего_капитального_ремонта As Global.System.Nullable(Of Date),  _
                    ByVal p5 As String) As Integer
            Return Me.Update(адрес, год_постройки, общая_площадь, учебная_площадь, p1, общий_объем, конструктивные_особенности, потребление_электроэнергии_в_летнее_время, потребление_электроэнергии_в_зимнее_время, пиковое_потребление, потребления_тепла, характеристика_пожаро_опасности, характеристика_электро_опасности, дата_последнего_капитального_ремонта, даты_очередного_текущего_капитального_ремонта, p4, Original_номер_корпуса, Original_адрес, Original_год_постройки, Original_общая_площадь, Original_учебная_площадь, p2, Original_общий_объем, Original_конструктивные_особенности, Original_потребление_электроэнергии_в_летнее_время, Original_потребление_электроэнергии_в_зимнее_время, Original_пиковое_потребление, Original_потребления_тепла, Original_характеристика_пожаро_опасности, Original_характеристика_электро_опасности, Original_дата_последнего_капитального_ремонта, Original_даты_очередного_текущего_капитального_ремонта, p5, Original_номер_корпуса)
        End Function
    End Class
    ...
    Partial Public Class ПожаробезопасностьTableAdapter
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, true)>  _
        Public Overloads Overridable Function Fill(ByVal dataTable As universityDataSet.ПожаробезопасностьDataTable) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            If (Me.ClearBeforeFill = true) Then
                dataTable.Clear
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Overridable Function GetData() As universityDataSet.ПожаробезопасностьDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As universityDataSet.ПожаробезопасностьDataTable = New universityDataSet.ПожаробезопасностьDataTable()
            Me.Adapter.Fill(dataTable)
            Return dataTable
        End Function
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As universityDataSet.ПожаробезопасностьDataTable) As Integer
            Return Me.Adapter.Update(dataTable)
        End Function
    ...
    Partial Public Class ПомещенияTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.DeleteCommand.Connection = Me.Connection
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [Помещения] WHERE (((@IsNull_номер_корпуса = 1 AND [номер корпуса] IS"& _ 
                " NULL) OR ([номер корпуса] = @Original_номер_корпуса)) AND ((@IsNull_номер_помещ"& _ 
                "ения = 1 AND [номер помещения] IS NULL) OR ([номер помещения] = @Original_номер_"& _ 
                "помещения)) AND ((@IsNull_этаж = 1 AND [этаж] IS NULL) OR ([этаж] = @Original_эт"& _ 
                "аж)) AND ((@IsNull_площадь = 1 AND [площадь] IS NULL) OR ([площадь] = @Original_"& _ 
                "площадь)) AND ((@IsNull_объем = 1 AND [объем] IS NULL) OR ([объем] = @Original_о"& _ 
                "бъем)) AND ((@IsNull_вид_помещения = 1 AND [вид помещения] IS NULL) OR ([вид пом"& _ 
                "ещения] = @Original_вид_помещения)) AND ((@IsNull_конструктивные_особенности = 1"& _ 
                " AND [конструктивные особенности] IS NULL) OR ([конструктивные особенности] = @O"& _ 
                "riginal_конструктивные_особенности)) AND ((@p3 = 1 AND [категория электро - безо"& _ 
                "пасности] IS NULL) OR ([категория электро - безопасности] = @p2)) AND ((@p6 = 1 "& _ 
                "AND [категория пожаро-безопасности] IS NULL) OR ([категория пожаро-безопасности]"& _ 
                " = @p5)) AND ((@IsNull_потребляемая_мощность_электроэнергии = 1 AND [потребляема"& _ 
                "я мощность электроэнергии] IS NULL) OR ([потребляемая мощность электроэнергии] ="& _ 
                " @Original_потребляемая_мощность_электроэнергии)) AND ((@IsNull_дата_последнего_"& _ 
                "капитального_ремонта = 1 AND [дата последнего капитального ремонта] IS NULL) OR "& _ 
                "([дата последнего капитального ремонта] = @Original_дата_последнего_капитального"& _ 
                "_ремонта)) AND ((@IsNull_даты_очередного_текущего_капитального_ремонта = 1 AND ["& _ 
                "даты очередного текущего капитального ремонта] IS NULL) OR ([даты очередного тек"& _ 
                "ущего капитального ремонта] = @Original_даты_очередного_текущего_капитального_ре"& _ 
                "монта)) AND ([id] = @Original_id))"
            Me._adapter.DeleteCommand.CommandType = Global.System.Data.CommandType.Text
            ...
            Me._adapter.InsertCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [Помещения] ([номер корпуса], [номер помещения], [этаж], [площадь], ["& _ 
                "объем], [вид помещения], [конструктивные особенности], [категория электро - безо"& _ 
                "пасности], [категория пожаро-безопасности], [потребляемая мощность электроэнерги"& _ 
                "и], [дата последнего капитального ремонта], [даты очередного текущего капитально"& _ 
                "го ремонта]) VALUES (@номер_корпуса, @номер_помещения, @этаж, @площадь, @объем, "& _ 
                "@вид_помещения, @конструктивные_особенности, @p1, @p4, @потребляемая_мощность_эл"& _ 
                "ектроэнергии, @дата_последнего_капитального_ремонта, @даты_очередного_текущего_к"& _ 
                "апитального_ремонта);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT [номер корпуса], [номер помещения], этаж, площадь,"& _ 
                " объем, [вид помещения], [конструктивные особенности], [категория электро - безо"& _ 
                "пасности], [категория пожаро-безопасности], [потребляемая мощность электроэнерги"& _ 
                "и], [дата последнего капитального ремонта], [даты очередного текущего капитально"& _ 
                "го ремонта], id FROM Помещения WHERE (id = SCOPE_IDENTITY())"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            ...
            Me._adapter.UpdateCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE [Помещения] SET [номер корпуса] = @номер_корпуса, [номер помещения] = @ном"& _ 
                "ер_помещения, [этаж] = @этаж, [площадь] = @площадь, [объем] = @объем, [вид помещ"& _ 
                "ения] = @вид_помещения, [конструктивные особенности] = @конструктивные_особеннос"& _ 
                "ти, [категория электро - безопасности] = @p1, [категория пожаро-безопасности] = "& _ 
                "@p4, [потребляемая мощность электроэнергии] = @потребляемая_мощность_электроэнер"& _ 
                "гии, [дата последнего капитального ремонта] = @дата_последнего_капитального_ремо"& _ 
                "нта, [даты очередного текущего капитального ремонта] = @даты_очередного_текущего"& _ 
                "_капитального_ремонта WHERE (((@IsNull_номер_корпуса = 1 AND [номер корпуса] IS "& _ 
                "NULL) OR ([номер корпуса] = @Original_номер_корпуса)) AND ((@IsNull_номер_помеще"& _ 
                "ния = 1 AND [номер помещения] IS NULL) OR ([номер помещения] = @Original_номер_п"& _ 
                "омещения)) AND ((@IsNull_этаж = 1 AND [этаж] IS NULL) OR ([этаж] = @Original_эта"& _ 
                "ж)) AND ((@IsNull_площадь = 1 AND [площадь] IS NULL) OR ([площадь] = @Original_п"& _ 
                "лощадь)) AND ((@IsNull_объем = 1 AND [объем] IS NULL) OR ([объем] = @Original_об"& _ 
                "ъем)) AND ((@IsNull_вид_помещения = 1 AND [вид помещения] IS NULL) OR ([вид поме"& _ 
                "щения] = @Original_вид_помещения)) AND ((@IsNull_конструктивные_особенности = 1 "& _ 
                "AND [конструктивные особенности] IS NULL) OR ([конструктивные особенности] = @Or"& _ 
                "iginal_конструктивные_особенности)) AND ((@p3 = 1 AND [категория электро - безоп"& _ 
                "асности] IS NULL) OR ([категория электро - безопасности] = @p2)) AND ((@p6 = 1 A"& _ 
                "ND [категория пожаро-безопасности] IS NULL) OR ([категория пожаро-безопасности] "& _ 
                "= @p5)) AND ((@IsNull_потребляемая_мощность_электроэнергии = 1 AND [потребляемая"& _ 
                " мощность электроэнергии] IS NULL) OR ([потребляемая мощность электроэнергии] = "& _ 
                "@Original_потребляемая_мощность_электроэнергии)) AND ((@IsNull_дата_последнего_к"& _ 
                "апитального_ремонта = 1 AND [дата последнего капитального ремонта] IS NULL) OR ("& _ 
                "[дата последнего капитального ремонта] = @Original_дата_последнего_капитального_"& _ 
                "ремонта)) AND ((@IsNull_даты_очередного_текущего_капитального_ремонта = 1 AND [д"& _ 
                "аты очередного текущего капитального ремонта] IS NULL) OR ([даты очередного теку"& _ 
                "щего капитального ремонта] = @Original_даты_очередного_текущего_капитального_рем"& _ 
                "онта)) AND ([id] = @Original_id));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT [номер корпуса], [номер помещения], э"& _ 
                "таж, площадь, объем, [вид помещения], [конструктивные особенности], [категория э"& _ 
                "лектро - безопасности], [категория пожаро-безопасности], [потребляемая мощность "& _ 
                "электроэнергии], [дата последнего капитального ремонта], [даты очередного текуще"& _ 
                "го капитального ремонта], id FROM Помещения WHERE (id = @id)"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT [номер корпуса], [номер помещения], этаж, площадь, объем, [вид помещения],"& _ 
                " [конструктивные особенности], [категория электро - безопасности], [категория по"& _ 
                "жаро-безопасности], [потребляемая мощность электроэнергии], [дата последнего кап"& _ 
                "итального ремонта], [даты очередного текущего капитального ремонта], id FROM Пом"& _ 
                "ещения"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, true)>  _
        Public Overloads Overridable Function Fill(ByVal dataTable As universityDataSet.ПомещенияDataTable) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            If (Me.ClearBeforeFill = true) Then
                dataTable.Clear
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Overridable Function GetData() As universityDataSet.ПомещенияDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As universityDataSet.ПомещенияDataTable = New universityDataSet.ПомещенияDataTable()
            Me.Adapter.Fill(dataTable)
            Return dataTable
        End Function
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As universityDataSet.ПомещенияDataTable) As Integer
            Return Me.Adapter.Update(dataTable)
        End Function
        ...
        Public Overloads Overridable Function Delete(ByVal Original_номер_корпуса As Global.System.Nullable(Of Long), ByVal Original_номер_помещения As Global.System.Nullable(Of Long), ByVal Original_этаж As Global.System.Nullable(Of Long), ByVal Original_площадь As Global.System.Nullable(Of Long), ByVal Original_объем As Global.System.Nullable(Of Long), ByVal Original_вид_помещения As String, ByVal Original_конструктивные_особенности As String, ByVal p2 As String, ByVal p5 As String, ByVal Original_потребляемая_мощность_электроэнергии As Global.System.Nullable(Of Long), ByVal Original_дата_последнего_капитального_ремонта As Global.System.Nullable(Of Date), ByVal Original_даты_очередного_текущего_капитального_ремонта As Global.System.Nullable(Of Date), ByVal Original_id As Long) As Integer
            ...
            If (Original_номер_помещения.HasValue = true) Then
                ...
                Me.Adapter.DeleteCommand.Parameters(3).Value = CType(Original_номер_помещения.Value,Long)
            Else
            ...
            If (Original_этаж.HasValue = true) Then
                ...
                Me.Adapter.DeleteCommand.Parameters(5).Value = CType(Original_этаж.Value,Long)
            Else
            ...
            If (Original_площадь.HasValue = true) Then
                ...
                Me.Adapter.DeleteCommand.Parameters(7).Value = CType(Original_площадь.Value,Long)
            Else
            ...
            If (Original_объем.HasValue = true) Then
                ...
                Me.Adapter.DeleteCommand.Parameters(9).Value = CType(Original_объем.Value,Long)
            Else
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(11).Value = CType(Original_вид_помещения,String)
            End If
            If (Original_конструктивные_особенности Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(13).Value = CType(Original_конструктивные_особенности,String)
            End If
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(15).Value = CType(p2,String)
            End If
            If (p5 Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(17).Value = CType(p5,String)
            End If
            If (Original_потребляемая_мощность_электроэнергии.HasValue = true) Then
                Me.Adapter.DeleteCommand.Parameters(18).Value = CType(0,Object)
                Me.Adapter.DeleteCommand.Parameters(19).Value = CType(Original_потребляемая_мощность_электроэнергии.Value,Long)
            Else
            ...
            If (Original_дата_последнего_капитального_ремонта.HasValue = true) Then
                ...
                Me.Adapter.DeleteCommand.Parameters(21).Value = CType(Original_дата_последнего_капитального_ремонта.Value,Date)
            Else
            ...
            If (Original_даты_очередного_текущего_капитального_ремонта.HasValue = true) Then
                ...
                Me.Adapter.DeleteCommand.Parameters(23).Value = CType(Original_даты_очередного_текущего_капитального_ремонта.Value,Date)
            Else
        ...
        Public Overloads Overridable Function Update( _
            ...
            If (Original_номер_корпуса.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(13).Value = CType(Original_номер_корпуса.Value,Long)
            Else
            ...
            If (Original_номер_помещения.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(15).Value = CType(Original_номер_помещения.Value,Long)
            Else
            ...
            If (Original_этаж.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(17).Value = CType(Original_этаж.Value,Long)
            Else
            ...
            If (Original_площадь.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(19).Value = CType(Original_площадь.Value,Long)
            Else
            ...
            If (Original_объем.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(21).Value = CType(Original_объем.Value,Long)
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(23).Value = CType(Original_вид_помещения,String)
            End If
            If (Original_конструктивные_особенности Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(25).Value = CType(Original_конструктивные_особенности,String)
            End If
            If (p2 Is Nothing) Then
            ...
            If (Original_потребляемая_мощность_электроэнергии.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(31).Value = CType(Original_потребляемая_мощность_электроэнергии.Value,Long)
            Else
            ...
            If (Original_дата_последнего_капитального_ремонта.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(33).Value = CType(Original_дата_последнего_капитального_ремонта.Value,Date)
            Else
            ...
            If (Original_даты_очередного_текущего_капитального_ремонта.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(35).Value = CType(Original_даты_очередного_текущего_капитального_ремонта.Value,Date)
            Else
    ...
    Partial Public Class ЭлектробезопасностьTableAdapter
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, true)>  _
        Public Overloads Overridable Function Fill(ByVal dataTable As universityDataSet.ЭлектробезопасностьDataTable) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            If (Me.ClearBeforeFill = true) Then
                dataTable.Clear
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Overridable Function GetData() As universityDataSet.ЭлектробезопасностьDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As universityDataSet.ЭлектробезопасностьDataTable = New universityDataSet.ЭлектробезопасностьDataTable()
            Me.Adapter.Fill(dataTable)
            Return dataTable
        End Function
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As universityDataSet.ЭлектробезопасностьDataTable) As Integer
            Return Me.Adapter.Update(dataTable)
        End Function
    ...
    <Global.System.ComponentModel.DesignerCategoryAttribute("code"),  _
     ...
     Global.System.ComponentModel.DesignerAttribute("Microsoft.VSDesigner.DataSource.Design.TableAdapterDesigner, Microsoft.VSDesigner"& _ 
        ", Version=10.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"),  _
     Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
    Partial Public Class Корпуса_ПомещенияTableAdapter
        Inherits Global.System.ComponentModel.Component
        ...
        Private Sub InitAdapter()
            ...
            Dim tableMapping As Global.System.Data.Common.DataTableMapping = New Global.System.Data.Common.DataTableMapping()
            tableMapping.SourceTable = "Table"
            tableMapping.DataSetTable = "Корпуса Помещения"
            tableMapping.ColumnMappings.Add("номер помещения", "номер помещения")
            tableMapping.ColumnMappings.Add("этаж", "этаж")
            tableMapping.ColumnMappings.Add("площадь", "площадь")
            tableMapping.ColumnMappings.Add("объем", "объем")
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT [номер помещения], этаж, площадь, объем, Expr2, [вид помещения], [категори"& _ 
                "я электро - безопасности], [категория пожаро-безопасности], [потребляемая мощнос"& _ 
                "ть электроэнергии], Expr3, Expr4, [номер корпуса], адрес FROM dbo.[Корпуса Помещ"& _ 
                "ения]"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, true)>  _
        Public Overloads Overridable Function Fill(ByVal dataTable As universityDataSet.Корпуса_ПомещенияDataTable) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            If (Me.ClearBeforeFill = true) Then
                dataTable.Clear
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Overridable Function GetData() As universityDataSet.Корпуса_ПомещенияDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As universityDataSet.Корпуса_ПомещенияDataTable = New universityDataSet.Корпуса_ПомещенияDataTable()
            Me.Adapter.Fill(dataTable)
            Return dataTable
        End Function
    End Class
